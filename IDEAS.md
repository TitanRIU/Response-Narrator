...
- **History navigation (Back/Forward through past responses).** Proposed as a CD-player-style feature, declined 2026-08-07: without a visible list of past responses, Back/Forward buttons would make the user guess blindly which message they're jumping to. Superseded by the persistent, clickable transcript shipped in 0.1.9, which solves the same problem with actual visibility into the destination before clicking.
